        ...
        mSendButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(mNewMessage.getText().equals("")){
                    ...
                    sendMessage(mNewMessage.getText().toString(), destination.getText().toString());

                    //Get the conversation ID.
                    String id = "";
                    String where = "address = " + destination.getText().toString();
                    ...
                    intent.putExtra("number", destination.getText().toString());
    ...
    public ArrayList<String> getContactNumbers(ArrayList<String> id){
        ...
        for(int i = 0; i < id.size(); i++){
            ...
            while (contactCursor.moveToNext()){
                numbers.add(contactCursor.getString(contactCursor.getColumnIndex(ContactsContract.CommonDataKinds.Phone.NUMBER)));
            }
        }
        return numbers;
    }
